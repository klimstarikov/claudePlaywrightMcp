...
/**
 * Page object for the Books category page on automationteststore.com.
 * Covers the category listing with Audio CD / Paperback sub-category links.
 */
export class BooksPage extends BasePage {
  /** Heading that identifies the Books category page. */
  ...
  /**
   * Returns true when the Books page heading is visible.
   */
